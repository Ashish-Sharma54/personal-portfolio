      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <Button 
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105"
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-slate-600 hover:border-blue-400 hover:text-blue-400 transition-all duration-300"
